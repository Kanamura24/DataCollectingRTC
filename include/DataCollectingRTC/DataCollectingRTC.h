...
#ifndef DATACOLLECTINGRTC_H
#define DATACOLLECTINGRTC_H
...
/*!
 * @class DataCollectingRTC
 * @brief DataCollectingRTC
 *
 * Manipulator Common Interface (SI unit version 1.0) Test
 * RT-component. This is a console application for testing
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  DataCollectingRTC(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void DataCollectingRTCInit(RTC::Manager* manager);
};

#endif // DATACOLLECTINGRTC_H
